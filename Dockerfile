...
#            php8.0-pgsql \
    ...
    # MONGODB
    && ln -sf /etc/php/8.0/mods-available/mongodb.ini /etc/php/8.0/fpm/conf.d/20-mongodb.ini \
    && ln -sf /etc/php/8.0/mods-available/mongodb.ini /etc/php/8.0/cli/conf.d/20-mongodb.ini \
    # Install Composer
